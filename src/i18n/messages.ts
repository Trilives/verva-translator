...
const en = {
  ...
  normal: "Normal", natural: "Natural", conversation: "Daily conversation", business: "Business",
  command: "Command issuance", professional: "Professional",
...
const zh: typeof en = {
  ...
  normal: "普通", natural: "自然", conversation: "日常对话", business: "商务", command: "命令下达", professional: "专业",
  ...
  modelRefreshFailed: "无法刷新模型列表", loadingModels: "正在加载模型…", savedAutomatically: "更改会自动保存",
  thinking: "思考模式",
